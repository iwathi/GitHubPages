$(function(){
	setTimeout(function(){
		...
		$(".l2").velocity({opacity:1, top: 0 }, {delay:0, duration:500, easing:"spring" });
		$(".l3").velocity({opacity:1, top: 0 }, {delay:0, duration:400, easing:"spring" });
		$(".l4").velocity({opacity:1, top: 0 }, {delay:0, duration:300, easing:"spring" });
		$(".l5").velocity({opacity:1, top: 0 }, {delay:0, duration:400, easing:"spring" });
		$(".l6").velocity({opacity:1, top: 0 }, {delay:0, duration:500, easing:"spring" });
		//$(".l1").velocity({height: "50px" }, {queue: false, easing:"spring" });
